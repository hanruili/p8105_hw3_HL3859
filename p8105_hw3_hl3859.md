...
The `citi_bike` data has 99485 observations and 9 variables.

- ride_id: Unique identifier for each ride (e.g., 4BE06CB33B037044)

- rideable_type: Type of bike used for the ride, typically either
  “classic” or “electric”
...
- member_casual: Rider type, indicating whether the rider is a Citi Bike
  member or a casual user
...
Members are the dominant users of the system, and their ridership has
grown significantly from 2020 to 2024. There are more rides in July
compared to January, consistent with better summer weather. While
members remain the primary users, casual rider usage has also increased
over time, indicating broader adoption of the Citi Bike system.
...
![](p8105_hw3_hl3859_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->

July has longer ride durations than January, driven by better weather
conditions in the summer. Weekend rides (Saturday and Sunday) tend to be
longer, particularly in July, likely due to recreational use. Ride
durations are generally shorter in 2024 compared to 2020, potentially
indicating a shift in rider behavior or an increase in the usage of
electric bikes for shorter trips.
...
![](p8105_hw3_hl3859_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->

Short trips dominate the Citi Bike system, with most rides being under
10 minutes regardless of the bike type or rider’s membership status.
Casual riders tend to have slightly longer ride durations than members,
possibly due to different use cases. Electric bikes show a similar ride
duration distribution for both casual and member riders, likely due to
their appeal for short, efficient trips. Seasonal differences are
present but subtle, with July showing slightly longer rides, especially
for casual riders.
